...
function CanadaAddressSearch(props) {
    ...
    return (_jsxs("div", __assign({ className: props.rootClassName, "has-error": errorMessage ? "true" : "false", "is-required": props.required ? "true" : "false" }, { children: [props.label &&
                _jsx("label", __assign({ className: props.labelClassName }, { children: props.label }), void 0), _jsx("input", { disabled: disabled, id: fieldId, value: props.value, onChange: props.onChange, className: props.inputClassName, required: props.required }, void 0), props.errorMessage &&
                _jsx("div", __assign({ className: props.errorMessageClassName }, { children: props.errorMessage }), void 0)] }), void 0));
}
